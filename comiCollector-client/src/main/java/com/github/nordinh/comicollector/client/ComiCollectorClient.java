package com.github.nordinh.comicollector.client;
...
public class ComiCollectorClient {

    private final Client client;
    private final JerseyClientBuilder clientBuilder;
    private final URI root;

    public ComiCollectorClient(Client client, URI root) {
        this.client = client;
        this.clientBuilder = null;
        this.root = root;
    }

    public ComiCollectorClient(JerseyClientBuilder clientBuilder, URI root) {
        this.client = null;
    ...
    private static Client buildClient(JerseyClientBuilder clientBuilder) {
        ...
        return builder
            ...
            .using(jerseyConfig).build("comiCollectorClient");
    }
}
